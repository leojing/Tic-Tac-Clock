...
extension SelectionType {
    ...
    func getContentList() -> [String?]? {
        ...
        case .watchFace:
            return ["chronography-black", "chronography-blue", "chronography-brown", "chronography-green", "chronography-grey", "chronography-light-blue", "chronography-light-grey", "chronography-light-yellow", Date().timeOfCounter(), Date().timeOfCounter()]
        }
    }
